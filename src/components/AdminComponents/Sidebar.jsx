    ...
    <div className="sidebar">
      <div className="sidebar__inner">
        ...
        <div className="sidebar__middle">
          <NavLink to="/admin/" className={({ isActive }) => (isActive ? "active sidebar__link" : "sidebar__link")}>
          ...
          <NavLink to="settings" className={({ isActive }) => (isActive ? "active sidebar__link" : "sidebar__link")}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
